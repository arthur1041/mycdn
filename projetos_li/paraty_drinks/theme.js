...
$(function () {
    ...
    LI.methods.otherCategories = function () {
        ...
        $(".full.menu .nivel-um > li").length > 1 && ($(".full.menu .conteiner .nivel-um>li:nth-child(1)").before('<li class="all-categories com-filho"><a href="#"><strong class="titulo"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="15" viewBox="0 0 18 15"><path d="M1,15a1,1,0,0,1-1-1V13a1,1,0,0,1,1-1H9a1,1,0,0,1,1,1v1a1,1,0,0,1-1,1ZM1,9A1,1,0,0,1,0,8V7A1,1,0,0,1,1,6H17a1,1,0,0,1,1,1V8a1,1,0,0,1-1,1ZM1,3A1,1,0,0,1,0,2V1A1,1,0,0,1,1,0H17a1,1,0,0,1,1,1V2a1,1,0,0,1-1,1Z" fill="#505050"/></svg> Todas as Categorias<strong></strong></strong></a><ul class="nivel-dois"></ul></li>'), $(".full.menu .conteiner .nivel-um>li.all-categories.com-filho>ul.nivel-dois").append($(".menu.superior .nivel-um>li").clone()))
